                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                           ...
                           outlets == null
                              ?Center(child: CircularProgressIndicator(),): outlets.isEmpty?
                          Container(
                                                                ...
                                                                Container(
                                                                  width:
                                                                      size.width *
                                                                          0.55,
                                                                  child: Text(
                                                                    outlets[index]["address1"] + " " + outlets[index]["address2"] + outlets[index]["locality"] + " " + outlets[index]["province"]+ ", " + outlets[index]["postcode"] ,
                                                                    style: TextStyle(
                                                                        fontSize: size.height >
                                                                                1280
                                                                            ? 14
